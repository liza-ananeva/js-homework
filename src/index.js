            ...
            if (child instanceof Text) {
                ...
                if (classes) {
                    for (let eachClass of classes) {
                        if (statistics.classes.hasOwnProperty(eachClass)) {
                            statistics.classes[eachClass]++;
                        } else {
                ...
                if (statistics.tags.hasOwnProperty(tag)) {
                    statistics.tags[tag]++;
                } else {
